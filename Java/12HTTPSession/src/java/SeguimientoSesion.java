...
public class SeguimientoSesion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Quiero la dechas de la creacion de la sesion
            long fechacreacion = sesioncli.getCreationTime();

            // Quiero saber cuando fue zu ultimo accecos
            long ultimoacceso = sesioncli.getLastAccessedTime();

            // Vamos a incrementar un contador para saber cuantas veces ha iniciado sesion dentro del navegador
            ...
            if (cuenta == null) {
                ...
                // Se encarga de sumar +1 las veces que entra
            ...
            out.println("Atributos de la sesión: ");
